  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    submitsub.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        if (!checkinput(inputamount)) {
        ...
        } else if (already(orginaluser, editsubname.getText().toString().toLowerCase())
            && counter == 0) {
          ...
          counter = 1;
            ...
            && counter == 1) {
          String result =
              "Subscription: " + editsubname.getText().toString() + "\nValue: $" + editsubvalue
                  .getText().toString().substring(1);
          textminisub.setText(result);
          orginaluser.setSubscription(editsubname.getText().toString().toLowerCase(),
              Float.parseFloat(editsubvalue.getText().toString().substring(1)));

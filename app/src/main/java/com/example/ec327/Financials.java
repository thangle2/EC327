...
public class Financials extends User implements Serializable {
    ...
    protected float transportation;                     //Transportation Cost (Weekly/not Monthly)
    ...
    public void setTotalInvestment(float total) {
    ...
    }                                                           // Return Weekly Budget as a subdivision of Monthly Budget
    ...
    public float getWeeklySpending() {
        ...
        return result;
    }                                                           // Calculates Weekly Spending Summation from Hashmap

...
/*This is autogenerated along with the page- make sure Editing these would make changes on the UI*/
    ...
    buttontran.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        if (edittran.getText().toString().substring(1).trim().equalsIgnoreCase("")) {
          ...
          orginaluser
              .setTransportation(Float.parseFloat(edittran.getText().toString().substring(1)));

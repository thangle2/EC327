  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    submitinvestment.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        if (!checkinput(inputamountz)) {
        ...
        } else if (already(orginaluser, editinvestmentname.getText().toString().toLowerCase())
            && counter == 0) {
          ...
          String result = "Subscription: " + editinvestmentname.getText().toString() + "\nValue: $"
              + editinvestmentvalue.getText().toString().substring(1);
          textminiinvestment.setText(result);
          orginaluser.setInvestment(editinvestmentname.getText().toString().toLowerCase(),
              Float.parseFloat(editinvestmentvalue.getText().toString().substring(1)));
